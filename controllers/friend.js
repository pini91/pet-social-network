...
module.exports = {
  ...
  getFriend: async (req, res) => {
    try {
      ...
      const followedBy = friendFollows.FollowedBy ? friendFollows.FollowFriends.length : 0 // This is the number of users that the current user is following.
      const follows = friendFollows.FollowFriends ? friendFollows.FollowedBy.length : 0 // This is the number of users that follow the current user.
